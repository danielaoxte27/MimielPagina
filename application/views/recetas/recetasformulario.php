...
.tarjeta-recetasformulario .telefono-numero {
    color: #e69d00;
    font-weight: 700;
    font-size: 1.05rem;
}

.tarjeta-recetasformulario .horario {
    color: #666;
    font-size: .85rem;
    margin: 4px 0 14px;
    line-height: 1.6;
...
.tarjeta-recetasformulario .correo-link {
    color: #e69d00;
    font-weight: 600;
    font-size: .95rem;
    display: block;
...
.tarjeta-recetasformulario .direccion {
    color: #555;
    font-size: .9rem;
    line-height: 1.6;
    margin-bottom: 14px;
...
<section class="recetasformulario-wrapper">
    ...
    <!-- TARJETAS -->
    <!--<div class="recetasformulario-tarjetas">

        <?php foreach($canales as $canal): ?>
        <div class="tarjeta-recetasformulario">
